 ...
 *
 * This is also yoinked from Funkin, I don't know how memory stuff works ;-;
 *
...
class MemoryUtil
{
	...
	{
		#if (windows && cpp)
		return util.external.windows.WinAPI.getProcessMemoryWorkingSetSize();
		#elseif ((ios || macos) && cpp)
		return util.external.apple.MemoryUtil.getCurrentProcessRss();
